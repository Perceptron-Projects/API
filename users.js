...
app.get(
  "/api/users/:userId",
  rolesMiddleware(["admin", "branchadmin", "hr", "employee"]),
  async function (req, res) {
    const params = {
      TableName: EMPLOYEES_TABLE,
      Key: {
...
app.patch(
  ...
  async function (req, res) {
    ...
    const updateParams = {
      ...
      UpdateExpression:
        "SET branchId = :branchId, contactNo = :contactNo, email = :email, firstName = :firstName, lastName = :lastName, username = :username, imageUrl = :imageUrl, branchName = :branchName",
      ExpressionAttributeValues: {
  ...
  async function (req, res) {
    try {
      ...
      const updateParams = {
        ...
        UpdateExpression:
          "SET companyName = :companyName, latitude = :latitude, email = :email, contactNo = :contactNo, longitude = :longitude, radiusFromCenterOfCompany = :radiusFromCenterOfCompany, companyImageUrl = :companyImageUrl",
        ExpressionAttributeValues: {
